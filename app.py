...
def gerar_senha_segura(tamanho=12):
    """Gera senha com letras maiúsculas, minúsculas, números e símbolos"""
...
# ==============================
# Página: Colaboradores (PARTE 2 – COM CONFIRMAÇÃO E ISOLAMENTO)
# ==============================
        ...
        if submitted and email:
            if "@" not in email or "." not in email:
                ...
                if existe:
                    ...
                    # Simular envio de e-mail (não envia de verdade)
    ...
    if st.session_state.colaboradores:
        for idx, colab in enumerate(st.session_state.colaboradores):
            ...
            **Dias restantes:** {max(dias_restantes, 0)}
            ...
            # Botões de controle (apenas para Rafael)
